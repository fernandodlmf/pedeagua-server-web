    ...
    function TableDataStorageFactory($log){
        ...
        TableDataStorageService.prototype.setAllRowsSelected = function(isSelected, isPaginationEnabled){
            ...
            _.each(this.storage, function(rowData){
                ...
                if (rowData.optionList.selected == true) {
                	linhasSelecionadas.push(rowData.rowId);
                	
                }
                
            });
            localStorage.removeItem(linhasSelecionadas);            
            localStorage.setItem('linhasSelecionadas', JSON.stringify(linhasSelecionadas));
            console.log('storage no md-data-table e:'+ JSON.stringify(linhasSelecionadas))
